...
namespace DevSkill.Inventory.Application.Tests.Products
{
    ...
    public class ProductAddCommandHandlerTests
    {
        ...
        public void Setup()
        {
            _handler = _moq.Create<ProductAddCommandHandler>();
        ...
        [Test]
        public async Task Handle_UniqueName_AddsProduct()
        {
            // Arrange
            ...
            _productRepositoryMock.Setup(x => x.AddAsync(product))
        ...
        public async Task Handle_DuplicateName_ThrowsException()
        {
            ...
            // Verify that AddAsync and SaveAsync were never called
